...
class LBImageSlider: UIView {
    ...
    private func commonInit() {
        Bundle.main.loadNibNamed(String(describing: LBImageSlider.self), owner: self, options: nil)
...
extension LBImageSlider: UIScrollViewDelegate {
